...
export default function CreateThread() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4" style={{ backgroundColor: '#FFFFEE' }}>
      <div className="mb-4">
        <div className="text-xs text-gray-600 mb-2">
          <Link href="/" className="text-blue-600 underline">Return to Catalog</Link>
        </div>
        <h2 className="text-lg font-bold text-red-800 mb-2">Start a New Thread</h2>
        <div className="text-xs text-gray-600 mb-4">
          Remember: All the stories and information posted here are artistic works of fiction.
        </div>
      </div>

      <div className="bg-blue-50 border border-gray-400 p-4 max-w-2xl">
